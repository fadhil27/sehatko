...
<head>
    ...
    <link rel="stylesheet" href="{{asset('home/plugin/evo-calendar/css/evo-calendar.css')}}">
    <link rel="stylesheet" href="{{asset('home/plugin/evo-calendar/css/evo-calendar.royal-navy.css')}}">
...
<body>
    ...
    <script src="{{asset('home/plugin/evo-calendar/js/evo-calendar.js')}}"></script>
    {{-- Validator --}}
